...
import { Play, X, Search, ArrowRight, CheckCircle2 } from 'lucide-react';
      ...
      <header className="relative w-full bg-[#0c1626] text-white overflow-hidden">
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-12 xl:px-16">
          ...
          >
            ...
            {/* Navigation Links */}
            <div className="hidden md:flex items-center space-x-3.5 lg:space-x-4 xl:space-x-5 text-sm font-medium text-slate-300">
              <button
                type="button"
              ...
              <button
                ...
                className="text-white font-semibold relative py-1 border-b-2 border-teal-400 cursor-pointer text-teal-300"
              >
                Academy
              </button>
              <button
              ...
              <button
                ...
                className="hover:text-white transition-colors duration-150 cursor-pointer text-blue-300 hover:text-blue-200"
              >
                Software
              </button>
              <button
